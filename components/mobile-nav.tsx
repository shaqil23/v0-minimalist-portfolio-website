        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-3/4 bg-background p-6 shadow-lg border-l border-border"
            >
              <div className="flex items-center justify-between border-b border-border pb-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button variant="ghost" size="icon" onClick={closeNav} className="ml-2">
                    <X className="h-5 w-5" />
              ...
              <nav className="mt-6">
                <ul className="space-y-0">
                  {navItems.map((item) => (
                    <motion.li key={item.href} whileHover={{ x: 5 }} className="border-b border-border">
                      <a
                        href={item.href}
                  ...
                  <motion.li whileHover={{ x: 5 }} className="border-b border-border">
                    <a
                      href={resumeUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center py-3 text-lg font-medium hover:text-primary transition-colors"
                      onClick={closeNav}
                    >
              ...
              <div className="mt-8 space-y-4">
                <h3 className="text-lg font-medium border-b border-border pb-2">Contact</h3>
